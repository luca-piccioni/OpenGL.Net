...
namespace OpenGL
{
	...
	public sealed class ModelMatrix : Matrix4x4, IModelMatrix
	{
		...
		/// </summary>
		/// <param name="p">
		/// A <see cref="Vertex3f"/> that specify the translation.
		/// </param>
		...
		/// </summary>
		/// <param name="x">
		/// A <see cref="Single"/> holding the scaling factor on X axis.
		/// </param>
		/// <param name="y">
		/// A <see cref="Single"/> holding the scaling factor on Y axis.
		/// </param>
		...
		/// </param>
		/// <param name="z">
		/// A <see cref="Single"/> holding the scaling factor on Z axis.
		/// </param>

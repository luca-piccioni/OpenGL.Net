...
namespace OpenGL
{
	public partial class Wfd
	{
		...
		/// <summary>
		/// Value of WFD_FALSE symbol.
		/// </summary>
		public const int FALSE = KHR_BOOLEAN_FALSE;

		/// <summary>
		/// Value of WFD_TRUE symbol.
		/// </summary>
		public const int TRUE = KHR_BOOLEAN_TRUE;
		...
		/// </summary>
		public const uint STRING_ID_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint ERROR_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint DEVICE_FILTER_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint COMMIT_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint DEVICE_ATTRIB_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint EVENT_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint EVENT_ATTRIB_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint PORT_MODE_ATTRIB_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint PORT_ATTRIB_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint PORT_TYPE_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint POWER_MODE_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint PARTIAL_REFRESH_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint DISPLAY_DATA_FORMAT_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint ROTATION_SUPPORT_FORMAT_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint PIPELINE_ATTRIB_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint SCALE_FILTER_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint TRANSPARENCY_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint TSC_FORMAT_FORCE_32BIT = 0x7FFFFFFF;
		...
		/// </summary>
		public const uint TRANSITION_FORCE_32BIT = 0x7FFFFFFF;

		public static int GetStrings(UInt32 device, WFDStringID name, [Out] char[][] strings, int stringsCount)
		{
			int retValue;

			unsafe {
				fixed (char** p_strings = strings)
				{
		...
		public static WFDboolean IsExtensionSupported(UInt32 device, [Out] char[] @string)
		{
			WFDboolean retValue;
		...
		public static int GetDisplayData(UInt32 device, UInt32 port, WFDDisplayDataFormat format, [Out] WFDuint8[] data, int dataCount)
		{
			int retValue;

			unsafe {
				fixed (WFDuint8* p_data = data)
				{
		...
		internal unsafe static partial class UnsafeNativeMethods
		{
			...
			internal extern static unsafe int wfdGetStrings(UInt32 device, WFDStringID name, char** strings, int stringsCount);

			[SuppressUnmanagedCodeSecurity()]
			[DllImport(Library, EntryPoint = "wfdIsExtensionSupported", ExactSpelling = true)]
			internal extern static unsafe WFDboolean wfdIsExtensionSupported(UInt32 device, char* @string);
			...
			internal extern static unsafe int wfdGetDisplayData(UInt32 device, UInt32 port, WFDDisplayDataFormat format, WFDuint8* data, int dataCount);
		...
		{
			[SuppressUnmanagedCodeSecurity()]
			internal unsafe delegate int wfdGetStrings(UInt32 device, WFDStringID name, char** strings, int stringsCount);

			internal static wfdGetStrings pwfdGetStrings;

			[SuppressUnmanagedCodeSecurity()]
			internal unsafe delegate WFDboolean wfdIsExtensionSupported(UInt32 device, char* @string);
			...
			[SuppressUnmanagedCodeSecurity()]
			internal unsafe delegate int wfdGetDisplayData(UInt32 device, UInt32 port, WFDDisplayDataFormat format, WFDuint8* data, int dataCount);

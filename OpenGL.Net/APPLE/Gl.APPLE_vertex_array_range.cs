...
namespace OpenGL
{
	public partial class Gl
	{
		...
		public static void VertexArrayRangeAPPLE(Int32 length, IntPtr pointer)
		{
			...
			CallLog("glVertexArrayRangeAPPLE({0}, {1})", length, pointer);
			DebugCheckErrors();
		}
		...
		public static void FlushVertexArrayRangeAPPLE(Int32 length, IntPtr pointer)
		{
			...
			CallLog("glFlushVertexArrayRangeAPPLE({0}, {1})", length, pointer);
			DebugCheckErrors();
		}
		...
		public static void VertexArrayParameterAPPLE(int pname, Int32 param)
		{
			...
			CallLog("glVertexArrayParameteriAPPLE({0}, {1})", pname, param);
			DebugCheckErrors();
		}

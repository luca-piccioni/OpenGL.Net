...
namespace OpenGL
{
	public partial class Gl
	{
		...
		public static void GetInternalformatSampleNV(int target, int internalformat, Int32 samples, int pname, Int32 bufSize, Int32[] @params)
		{
			...
			unsafe {
				fixed (Int32* p_params = @params)
				{
					...
					Delegates.pglGetInternalformatSampleivNV(target, internalformat, samples, pname, bufSize, p_params);
					CallLog("glGetInternalformatSampleivNV({0}, {1}, {2}, {3}, {4}, {5})", target, internalformat, samples, pname, bufSize, @params);
				}
			}
			DebugCheckErrors();
		}
		...
		/// </param>
		[RequiredByFeature("GL_NV_internalformat_sample_query")]
		public static void GetInternalformatSampleNV(int target, int internalformat, Int32 samples, int pname, Int32[] @params)
		{
			unsafe {
				fixed (Int32* p_params = @params)
				{

		...
		public static void VertexAttribs1hvNV(UInt32 index, Int32 n, UInt16[] v)
		{
			...
			unsafe {
				fixed (UInt16* p_v = v)
				{
					...
					Delegates.pglVertexAttribs1hvNV(index, n, p_v);
					CallLog("glVertexAttribs1hvNV({0}, {1}, {2})", index, n, v);
				}
			}
			DebugCheckErrors();
		}
		...
		public static void VertexAttribs3hvNV(UInt32 index, Int32 n, UInt16[] v)
		{
			...
			unsafe {
				fixed (UInt16* p_v = v)
				{
					...
					Delegates.pglVertexAttribs3hvNV(index, n, p_v);
					CallLog("glVertexAttribs3hvNV({0}, {1}, {2})", index, n, v);
				}
			}
			DebugCheckErrors();
		}

		...
		public static void GenOcclusionQueriesNV(UInt32[] ids)
		{
			unsafe {
				fixed (UInt32* p_ids = ids)
				{
					...
					LogFunction("glGenOcclusionQueriesNV({0}, {1})", ids.Length, ids);
				}
			}
		...
		public static void DeleteOcclusionQueriesNV(params UInt32[] ids)
		{
			unsafe {
				fixed (UInt32* p_ids = ids)
				{
					...
					LogFunction("glDeleteOcclusionQueriesNV({0}, {1})", ids.Length, ids);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void GetOcclusionQueryNV(UInt32 id, Int32 pname, [Out] Int32[] @params)
		{
			unsafe {
				fixed (Int32* p_params = @params)
				{
					...
					LogFunction("glGetOcclusionQueryivNV({0}, {1}, {2})", id, LogEnumName(pname), @params);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void GetOcclusionQueryuivNV(UInt32 id, Int32 pname, [Out] UInt32[] @params)
		{
			unsafe {
				fixed (UInt32* p_params = @params)
				{
					...
					LogFunction("glGetOcclusionQueryuivNV({0}, {1}, {2})", id, LogEnumName(pname), @params);
				}
			}
			DebugCheckErrors(null);
		}

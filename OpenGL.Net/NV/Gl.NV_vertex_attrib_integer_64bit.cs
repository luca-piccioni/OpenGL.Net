		...
		public static void VertexAttribL1NV(UInt32 index, Int64[] v)
		{
			unsafe {
				fixed (Int64* p_v = v)
				{
					...
					LogFunction("glVertexAttribL1i64vNV({0}, {1})", index, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribL2NV(UInt32 index, Int64[] v)
		{
			unsafe {
				fixed (Int64* p_v = v)
				{
					...
					LogFunction("glVertexAttribL2i64vNV({0}, {1})", index, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribL3NV(UInt32 index, Int64[] v)
		{
			unsafe {
				fixed (Int64* p_v = v)
				{
					...
					LogFunction("glVertexAttribL3i64vNV({0}, {1})", index, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribL4NV(UInt32 index, Int64[] v)
		{
			unsafe {
				fixed (Int64* p_v = v)
				{
					...
					LogFunction("glVertexAttribL4i64vNV({0}, {1})", index, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribL1NV(UInt32 index, UInt64[] v)
		{
			unsafe {
				fixed (UInt64* p_v = v)
				{
					...
					LogFunction("glVertexAttribL1ui64vNV({0}, {1})", index, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribL2NV(UInt32 index, UInt64[] v)
		{
			unsafe {
				fixed (UInt64* p_v = v)
				{
					...
					LogFunction("glVertexAttribL2ui64vNV({0}, {1})", index, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribL3NV(UInt32 index, UInt64[] v)
		{
			unsafe {
				fixed (UInt64* p_v = v)
				{
					...
					LogFunction("glVertexAttribL3ui64vNV({0}, {1})", index, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribL4NV(UInt32 index, UInt64[] v)
		{
			unsafe {
				fixed (UInt64* p_v = v)
				{
					...
					LogFunction("glVertexAttribL4ui64vNV({0}, {1})", index, v);
				}
			}
			DebugCheckErrors(null);
		}

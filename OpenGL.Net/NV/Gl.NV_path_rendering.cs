		...
		public static void PathCommandsNV(UInt32 path, byte[] commands, Int32 numCoords, Int32 coordType, IntPtr coords)
		{
			unsafe {
				fixed (byte* p_commands = commands)
				{
					...
					LogFunction("glPathCommandsNV({0}, {1}, {2}, {3}, {4}, 0x{5})", path, commands.Length, commands, numCoords, LogEnumName(coordType), coords.ToString("X8"));
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void PathSubCommandsNV(UInt32 path, Int32 commandStart, Int32 commandsToDelete, byte[] commands, Int32 numCoords, Int32 coordType, IntPtr coords)
		{
			unsafe {
				fixed (byte* p_commands = commands)
				{
					...
					LogFunction("glPathSubCommandsNV({0}, {1}, {2}, {3}, {4}, {5}, {6}, 0x{7})", path, commandStart, commandsToDelete, commands.Length, commands, numCoords, LogEnumName(coordType), coords.ToString("X8"));
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void TransformPathNV(UInt32 resultPath, UInt32 srcPath, Int32 transformType, float[] transformValues)
		{
			unsafe {
				fixed (float* p_transformValues = transformValues)
				{
					...
					LogFunction("glTransformPathNV({0}, {1}, {2}, {3})", resultPath, srcPath, LogEnumName(transformType), transformValues);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void PathParameterNV(UInt32 path, Int32 pname, Int32[] value)
		{
			unsafe {
				fixed (Int32* p_value = value)
				{
					...
					LogFunction("glPathParameterivNV({0}, {1}, {2})", path, LogEnumName(pname), value);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void PathParameterNV(UInt32 path, Int32 pname, float[] value)
		{
			unsafe {
				fixed (float* p_value = value)
				{
					...
					LogFunction("glPathParameterfvNV({0}, {1}, {2})", path, LogEnumName(pname), value);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void StencilFillPathInstancedNV(Int32 numPaths, Int32 pathNameType, IntPtr paths, UInt32 pathBase, Int32 fillMode, UInt32 mask, Int32 transformType, float[] transformValues)
		{
			unsafe {
				fixed (float* p_transformValues = transformValues)
				{
					...
					LogFunction("glStencilFillPathInstancedNV({0}, {1}, 0x{2}, {3}, {4}, {5}, {6}, {7})", numPaths, LogEnumName(pathNameType), paths.ToString("X8"), pathBase, LogEnumName(fillMode), mask, LogEnumName(transformType), transformValues);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void StencilStrokePathInstancedNV(Int32 numPaths, Int32 pathNameType, IntPtr paths, UInt32 pathBase, Int32 reference, UInt32 mask, Int32 transformType, float[] transformValues)
		{
			unsafe {
				fixed (float* p_transformValues = transformValues)
				{
					...
					LogFunction("glStencilStrokePathInstancedNV({0}, {1}, 0x{2}, {3}, {4}, {5}, {6}, {7})", numPaths, LogEnumName(pathNameType), paths.ToString("X8"), pathBase, reference, mask, LogEnumName(transformType), transformValues);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void CoverFillPathInstancedNV(Int32 numPaths, Int32 pathNameType, IntPtr paths, UInt32 pathBase, Int32 coverMode, Int32 transformType, float[] transformValues)
		{
			unsafe {
				fixed (float* p_transformValues = transformValues)
				{
					...
					LogFunction("glCoverFillPathInstancedNV({0}, {1}, 0x{2}, {3}, {4}, {5}, {6})", numPaths, LogEnumName(pathNameType), paths.ToString("X8"), pathBase, LogEnumName(coverMode), LogEnumName(transformType), transformValues);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void CoverStrokePathInstancedNV(Int32 numPaths, Int32 pathNameType, IntPtr paths, UInt32 pathBase, Int32 coverMode, Int32 transformType, float[] transformValues)
		{
			unsafe {
				fixed (float* p_transformValues = transformValues)
				{
					...
					LogFunction("glCoverStrokePathInstancedNV({0}, {1}, 0x{2}, {3}, {4}, {5}, {6})", numPaths, LogEnumName(pathNameType), paths.ToString("X8"), pathBase, LogEnumName(coverMode), LogEnumName(transformType), transformValues);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void GetPathParameterNV(UInt32 path, Int32 pname, [Out] Int32[] value)
		{
			unsafe {
				fixed (Int32* p_value = value)
				{
					...
					LogFunction("glGetPathParameterivNV({0}, {1}, {2})", path, LogEnumName(pname), value);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void GetPathParameterNV(UInt32 path, Int32 pname, [Out] float[] value)
		{
			unsafe {
				fixed (float* p_value = value)
				{
					...
					LogFunction("glGetPathParameterfvNV({0}, {1}, {2})", path, LogEnumName(pname), value);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void GetPathMetricsNV(UInt32 metricQueryMask, Int32 numPaths, Int32 pathNameType, IntPtr paths, UInt32 pathBase, Int32 stride, [Out] float[] metrics)
		{
			unsafe {
				fixed (float* p_metrics = metrics)
				{
					...
					LogFunction("glGetPathMetricsNV({0}, {1}, {2}, 0x{3}, {4}, {5}, {6})", metricQueryMask, numPaths, LogEnumName(pathNameType), paths.ToString("X8"), pathBase, stride, metrics);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void GetPathSpacingNV(Int32 pathListMode, Int32 numPaths, Int32 pathNameType, IntPtr paths, UInt32 pathBase, float advanceScale, float kerningScale, Int32 transformType, [Out] float[] returnedSpacing)
		{
			unsafe {
				fixed (float* p_returnedSpacing = returnedSpacing)
				{
					...
					LogFunction("glGetPathSpacingNV({0}, {1}, {2}, 0x{3}, {4}, {5}, {6}, {7}, {8})", LogEnumName(pathListMode), numPaths, LogEnumName(pathNameType), paths.ToString("X8"), pathBase, advanceScale, kerningScale, LogEnumName(transformType), returnedSpacing);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void MatrixLoad3x2NV(Int32 matrixMode, float[] m)
		{
			unsafe {
				fixed (float* p_m = m)
				{
					...
					LogFunction("glMatrixLoad3x2fNV({0}, {1})", LogEnumName(matrixMode), m);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void MatrixLoad3NV(Int32 matrixMode, float[] m)
		{
			unsafe {
				fixed (float* p_m = m)
				{
					...
					LogFunction("glMatrixLoad3x3fNV({0}, {1})", LogEnumName(matrixMode), m);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void MatrixLoadTransposeNV(Int32 matrixMode, float[] m)
		{
			unsafe {
				fixed (float* p_m = m)
				{
					...
					LogFunction("glMatrixLoadTranspose3x3fNV({0}, {1})", LogEnumName(matrixMode), m);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void MatrixMult3x2NV(Int32 matrixMode, float[] m)
		{
			unsafe {
				fixed (float* p_m = m)
				{
					...
					LogFunction("glMatrixMult3x2fNV({0}, {1})", LogEnumName(matrixMode), m);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void MatrixMult3x3NV(Int32 matrixMode, float[] m)
		{
			unsafe {
				fixed (float* p_m = m)
				{
					...
					LogFunction("glMatrixMult3x3fNV({0}, {1})", LogEnumName(matrixMode), m);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void MatrixMultTransposeNV(Int32 matrixMode, float[] m)
		{
			unsafe {
				fixed (float* p_m = m)
				{
					...
					LogFunction("glMatrixMultTranspose3x3fNV({0}, {1})", LogEnumName(matrixMode), m);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void StencilThenCoverFillPathInstancedNV(Int32 numPaths, Int32 pathNameType, IntPtr paths, UInt32 pathBase, Int32 fillMode, UInt32 mask, Int32 coverMode, Int32 transformType, float[] transformValues)
		{
			unsafe {
				fixed (float* p_transformValues = transformValues)
				{
					...
					LogFunction("glStencilThenCoverFillPathInstancedNV({0}, {1}, 0x{2}, {3}, {4}, {5}, {6}, {7}, {8})", numPaths, LogEnumName(pathNameType), paths.ToString("X8"), pathBase, LogEnumName(fillMode), mask, LogEnumName(coverMode), LogEnumName(transformType), transformValues);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void StencilThenCoverStrokePathInstancedNV(Int32 numPaths, Int32 pathNameType, IntPtr paths, UInt32 pathBase, Int32 reference, UInt32 mask, Int32 coverMode, Int32 transformType, float[] transformValues)
		{
			unsafe {
				fixed (float* p_transformValues = transformValues)
				{
					...
					LogFunction("glStencilThenCoverStrokePathInstancedNV({0}, {1}, 0x{2}, {3}, {4}, {5}, {6}, {7}, {8})", numPaths, LogEnumName(pathNameType), paths.ToString("X8"), pathBase, reference, mask, LogEnumName(coverMode), LogEnumName(transformType), transformValues);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static Int32 PathGlyphIndexRangeNV(Int32 fontTarget, IntPtr fontName, UInt32 fontStyle, UInt32 pathParameterTemplate, float emScale, UInt32[] baseAndCount)
		{
			...
			unsafe {
				fixed (UInt32* p_baseAndCount = baseAndCount)
				{
					...
					LogFunction("glPathGlyphIndexRangeNV({0}, 0x{1}, {2}, {3}, {4}, {5}) = {6}", LogEnumName(fontTarget), fontName.ToString("X8"), fontStyle, pathParameterTemplate, emScale, baseAndCount, retValue);
				}
			}
			DebugCheckErrors(retValue);
		...
		public static void ProgramPathFragmentInputGenNV(UInt32 program, Int32 location, Int32 genMode, Int32 components, float[] coeffs)
		{
			unsafe {
				fixed (float* p_coeffs = coeffs)
				{
					...
					LogFunction("glProgramPathFragmentInputGenNV({0}, {1}, {2}, {3}, {4})", program, location, LogEnumName(genMode), components, coeffs);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void GetProgramResourceNV(UInt32 program, Int32 programInterface, UInt32 index, Int32 propCount, Int32[] props, Int32 bufSize, [Out] Int32[] length, [Out] float[] @params)
		{
			unsafe {
				...
				fixed (float* p_params = @params)
				{
					...
					LogFunction("glGetProgramResourcefvNV({0}, {1}, {2}, {3}, {4}, {5}, {6}, {7})", program, LogEnumName(programInterface), index, propCount, LogEnumName(props), bufSize, length, @params);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void PathColorGenNV(Int32 color, Int32 genMode, Int32 colorFormat, float[] coeffs)
		{
			unsafe {
				fixed (float* p_coeffs = coeffs)
				{
					...
					LogFunction("glPathColorGenNV({0}, {1}, {2}, {3})", LogEnumName(color), LogEnumName(genMode), LogEnumName(colorFormat), coeffs);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void PathTexGenNV(Int32 texCoordSet, Int32 genMode, Int32 components, float[] coeffs)
		{
			unsafe {
				fixed (float* p_coeffs = coeffs)
				{
					...
					LogFunction("glPathTexGenNV({0}, {1}, {2}, {3})", LogEnumName(texCoordSet), LogEnumName(genMode), components, coeffs);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void GetPathColorGenNV(Int32 color, Int32 pname, [Out] Int32[] value)
		{
			unsafe {
				fixed (Int32* p_value = value)
				{
					...
					LogFunction("glGetPathColorGenivNV({0}, {1}, {2})", LogEnumName(color), LogEnumName(pname), value);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void GetPathColorGenNV(Int32 color, Int32 pname, [Out] float[] value)
		{
			unsafe {
				fixed (float* p_value = value)
				{
					...
					LogFunction("glGetPathColorGenfvNV({0}, {1}, {2})", LogEnumName(color), LogEnumName(pname), value);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void GetPathTexGenNV(Int32 texCoordSet, Int32 pname, [Out] Int32[] value)
		{
			unsafe {
				fixed (Int32* p_value = value)
				{
					...
					LogFunction("glGetPathTexGenivNV({0}, {1}, {2})", LogEnumName(texCoordSet), LogEnumName(pname), value);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void GetPathTexGenNV(Int32 texCoordSet, Int32 pname, [Out] float[] value)
		{
			unsafe {
				fixed (float* p_value = value)
				{
					...
					LogFunction("glGetPathTexGenfvNV({0}, {1}, {2})", LogEnumName(texCoordSet), LogEnumName(pname), value);
				}
			}
			DebugCheckErrors(null);
		}

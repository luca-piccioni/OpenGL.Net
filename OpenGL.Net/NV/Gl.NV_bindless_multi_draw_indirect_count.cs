...
namespace OpenGL
{
	public partial class Gl
	{
		...
		public static void MultiDrawElementsIndirectBindNV(Int32 mode, Int32 type, IntPtr indirect, Int32 drawCount, Int32 maxDrawCount, Int32 stride, Int32 vertexBufferCount)
		{
			...
			LogFunction("glMultiDrawElementsIndirectBindlessCountNV({0}, {1}, 0x{2}, {3}, {4}, {5}, {6})", mode, type, indirect.ToString("X8"), drawCount, maxDrawCount, stride, vertexBufferCount);
			DebugCheckErrors(null);
		}

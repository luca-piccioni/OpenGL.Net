		...
		public static bool AreProgramsResidentNV(UInt32[] programs, [Out] bool[] residences)
		{
			...
			unsafe {
				...
				fixed (bool* p_residences = residences)
				{
					...
					LogFunction("glAreProgramsResidentNV({0}, {1}, {2}) = {3}", programs.Length, programs, residences, retValue);
				}
			}
		...
		public static void RequestResidentProgramsNV(UInt32[] programs)
		{
			unsafe {
				fixed (UInt32* p_programs = programs)
				{
					...
					LogFunction("glRequestResidentProgramsNV({0}, {1})", programs.Length, programs);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribs1NV(UInt32 index, double[] v)
		{
			unsafe {
				fixed (double* p_v = v)
				{
					...
					LogFunction("glVertexAttribs1dvNV({0}, {1}, {2})", index, v.Length, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribs1NV(UInt32 index, float[] v)
		{
			unsafe {
				fixed (float* p_v = v)
				{
					...
					LogFunction("glVertexAttribs1fvNV({0}, {1}, {2})", index, v.Length, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribs1NV(UInt32 index, Int16[] v)
		{
			unsafe {
				fixed (Int16* p_v = v)
				{
					...
					LogFunction("glVertexAttribs1svNV({0}, {1}, {2})", index, v.Length, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribs2NV(UInt32 index, Int32 count, double[] v)
		{
			unsafe {
				fixed (double* p_v = v)
				{
					...
					LogFunction("glVertexAttribs2dvNV({0}, {1}, {2})", index, count, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribs2NV(UInt32 index, Int32 count, float[] v)
		{
			unsafe {
				fixed (float* p_v = v)
				{
					...
					LogFunction("glVertexAttribs2fvNV({0}, {1}, {2})", index, count, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribs2NV(UInt32 index, Int32 count, Int16[] v)
		{
			unsafe {
				fixed (Int16* p_v = v)
				{
					...
					LogFunction("glVertexAttribs2svNV({0}, {1}, {2})", index, count, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribs3NV(UInt32 index, Int32 count, double[] v)
		{
			unsafe {
				fixed (double* p_v = v)
				{
					...
					LogFunction("glVertexAttribs3dvNV({0}, {1}, {2})", index, count, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribs3NV(UInt32 index, Int32 count, float[] v)
		{
			unsafe {
				fixed (float* p_v = v)
				{
					...
					LogFunction("glVertexAttribs3fvNV({0}, {1}, {2})", index, count, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribs3NV(UInt32 index, Int32 count, Int16[] v)
		{
			unsafe {
				fixed (Int16* p_v = v)
				{
					...
					LogFunction("glVertexAttribs3svNV({0}, {1}, {2})", index, count, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribs4NV(UInt32 index, Int32 count, double[] v)
		{
			unsafe {
				fixed (double* p_v = v)
				{
					...
					LogFunction("glVertexAttribs4dvNV({0}, {1}, {2})", index, count, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribs4NV(UInt32 index, Int32 count, float[] v)
		{
			unsafe {
				fixed (float* p_v = v)
				{
					...
					LogFunction("glVertexAttribs4fvNV({0}, {1}, {2})", index, count, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribs4NV(UInt32 index, Int32 count, Int16[] v)
		{
			unsafe {
				fixed (Int16* p_v = v)
				{
					...
					LogFunction("glVertexAttribs4svNV({0}, {1}, {2})", index, count, v);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexAttribs4NV(UInt32 index, Int32 count, byte[] v)
		{
			unsafe {
				fixed (byte* p_v = v)
				{
					...
					LogFunction("glVertexAttribs4ubvNV({0}, {1}, {2})", index, count, v);
				}
			}
			DebugCheckErrors(null);
		}

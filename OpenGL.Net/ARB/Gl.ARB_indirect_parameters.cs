...
namespace OpenGL
{
	public partial class Gl
	{
		...
		public static void MultiDrawArraysIndirectARB(Int32 mode, IntPtr indirect, IntPtr drawcount, Int32 maxdrawcount, Int32 stride)
		{
			...
			CallLog("glMultiDrawArraysIndirectCountARB({0}, 0x{1}, 0x{2}, {3}, {4})", mode, indirect.ToString("X8"), drawcount.ToString("X8"), maxdrawcount, stride);
			DebugCheckErrors();
		}
		...
		public static void MultiDrawElementsIndirectARB(Int32 mode, Int32 type, IntPtr indirect, IntPtr drawcount, Int32 maxdrawcount, Int32 stride)
		{
			...
			CallLog("glMultiDrawElementsIndirectCountARB({0}, {1}, 0x{2}, 0x{3}, {4}, {5})", mode, type, indirect.ToString("X8"), drawcount.ToString("X8"), maxdrawcount, stride);
			DebugCheckErrors();
		}

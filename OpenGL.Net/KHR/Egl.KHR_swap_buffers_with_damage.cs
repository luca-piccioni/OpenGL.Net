...
namespace OpenGL
{
	public partial class Egl
	{
		...
		public static IntPtr SwapBuffersWithDamageKHR(IntPtr dpy, IntPtr surface, int[] rects, int n_rects)
		{
			IntPtr retValue;
			...
			unsafe {
				fixed (int* p_rects = rects)
				{
					...
					LogFunction("eglSwapBuffersWithDamageKHR(0x{0}, 0x{1}, {2}, {3}) = {4}", dpy.ToString("X8"), surface.ToString("X8"), LogValue(rects), n_rects, retValue.ToString("X8"));
				}
			}

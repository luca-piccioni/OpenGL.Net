...
namespace OpenGL
{
	public partial class Gl
	{
		...
		public static void DrawElementsInstancedEXT(PrimitiveType mode, Int32 count, int type, IntPtr indices, Int32 primcount)
		{
			...
			Delegates.pglDrawElementsInstancedEXT((int)mode, count, type, indices, primcount);
		...
		/// </param>
		[RequiredByFeature("GL_EXT_draw_instanced")]
		public static void DrawElementsInstancedEXT(PrimitiveType mode, Int32 count, int type, Object indices, Int32 primcount)
		{

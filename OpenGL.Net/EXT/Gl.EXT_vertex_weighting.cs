...
namespace OpenGL
{
	public partial class Gl
	{
		...
		public static void VertexWeightEXT(float weight)
		{
			...
			CallLog("glVertexWeightfEXT({0})", weight);
			DebugCheckErrors();
		}
		...
		public static void VertexWeightEXT(float[] weight)
		{
			unsafe {
				fixed (float* p_weight = weight)
				{
					...
					CallLog("glVertexWeightfvEXT({0})", weight);
				}
			}
			DebugCheckErrors();
		}
		...
		/// A <see cref="T:IntPtr"/>.
		/// </param>
		public static void VertexWeightPointerEXT(Int32 size, int type, Int32 stride, IntPtr pointer)
		{

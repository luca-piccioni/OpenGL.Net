...
namespace OpenGL
{
	public partial class Wgl
	{
		...
		public static IntPtr CreatePbufferEXT(IntPtr hDC, int iPixelFormat, int iWidth, int iHeight, int[] piAttribList)
		{
			...
			unsafe {
				fixed (int* p_piAttribList = piAttribList)
				{
					...
					CallLog("wglCreatePbufferEXT(0x{0}, {1}, {2}, {3}, {4}) = {5}", hDC.ToString("X8"), iPixelFormat, iWidth, iHeight, piAttribList, retValue.ToString("X8"));
				}
			}
		...
		public static IntPtr GetPbufferDCEXT(IntPtr hPbuffer)
		{
			...
			CallLog("wglGetPbufferDCEXT(0x{0}) = {1}", hPbuffer.ToString("X8"), retValue.ToString("X8"));
		...
		public static int ReleasePbufferDCEXT(IntPtr hPbuffer, IntPtr hDC)
		{
			...
			CallLog("wglReleasePbufferDCEXT(0x{0}, 0x{1}) = {2}", hPbuffer.ToString("X8"), hDC.ToString("X8"), retValue);
		...
		public static bool DestroyPbufferEXT(IntPtr hPbuffer)
		{
			...
			CallLog("wglDestroyPbufferEXT(0x{0}) = {1}", hPbuffer.ToString("X8"), retValue);
		...
		public static bool QueryPbufferEXT(IntPtr hPbuffer, int iAttribute, int[] piValue)
		{
			...
			unsafe {
				fixed (int* p_piValue = piValue)
				{
					...
					CallLog("wglQueryPbufferEXT(0x{0}, {1}, {2}) = {3}", hPbuffer.ToString("X8"), iAttribute, piValue, retValue);
				}
			}

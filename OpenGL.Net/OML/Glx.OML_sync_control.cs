...
namespace OpenGL
{
	public partial class Glx
	{
		...
		public static bool GetSyncValuesOML(IntPtr dpy, IntPtr drawable, [Out] Int64[] ust, [Out] Int64[] msc, [Out] Int64[] sbc)
		{
			...
			unsafe {
				...
				fixed (Int64* p_sbc = sbc)
				{
					...
					CallLog("glXGetSyncValuesOML(0x{0}, 0x{1}, {2}, {3}, {4}) = {5}", dpy.ToString("X8"), drawable.ToString("X8"), ust, msc, sbc, retValue);
				}
			}
		...
		public static bool GetMscRateOML(IntPtr dpy, IntPtr drawable, [Out] Int32[] numerator, [Out] Int32[] denominator)
		{
			...
			unsafe {
				...
				fixed (Int32* p_denominator = denominator)
				{
					...
					CallLog("glXGetMscRateOML(0x{0}, 0x{1}, {2}, {3}) = {4}", dpy.ToString("X8"), drawable.ToString("X8"), numerator, denominator, retValue);
				}
			}
		...
		public static Int64 SwapBuffersMscOML(IntPtr dpy, IntPtr drawable, Int64 target_msc, Int64 divisor, Int64 remainder)
		{
			...
			CallLog("glXSwapBuffersMscOML(0x{0}, 0x{1}, {2}, {3}, {4}) = {5}", dpy.ToString("X8"), drawable.ToString("X8"), target_msc, divisor, remainder, retValue);
		...
		public static bool WaitForMscOML(IntPtr dpy, IntPtr drawable, Int64 target_msc, Int64 divisor, Int64 remainder, Int64[] ust, Int64[] msc, Int64[] sbc)
		{
			...
			unsafe {
				...
				fixed (Int64* p_sbc = sbc)
				{
					...
					CallLog("glXWaitForMscOML(0x{0}, 0x{1}, {2}, {3}, {4}, {5}, {6}, {7}) = {8}", dpy.ToString("X8"), drawable.ToString("X8"), target_msc, divisor, remainder, ust, msc, sbc, retValue);
				}
			}
		...
		public static bool WaitForSbcOML(IntPtr dpy, IntPtr drawable, Int64 target_sbc, Int64[] ust, Int64[] msc, Int64[] sbc)
		{
			...
			unsafe {
				...
				fixed (Int64* p_sbc = sbc)
				{
					...
					CallLog("glXWaitForSbcOML(0x{0}, 0x{1}, {2}, {3}, {4}, {5}) = {6}", dpy.ToString("X8"), drawable.ToString("X8"), target_sbc, ust, msc, sbc, retValue);
				}
			}

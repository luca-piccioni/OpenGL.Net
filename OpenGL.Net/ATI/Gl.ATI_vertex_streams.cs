		...
		public static void VertexStream1ATI(Int32 stream, Int16[] coords)
		{
			unsafe {
				fixed (Int16* p_coords = coords)
				{
					...
					LogFunction("glVertexStream1svATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexStream1ATI(Int32 stream, Int32[] coords)
		{
			unsafe {
				fixed (Int32* p_coords = coords)
				{
					...
					LogFunction("glVertexStream1ivATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexStream1ATI(Int32 stream, float[] coords)
		{
			unsafe {
				fixed (float* p_coords = coords)
				{
					...
					LogFunction("glVertexStream1fvATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexStream1ATI(Int32 stream, double[] coords)
		{
			unsafe {
				fixed (double* p_coords = coords)
				{
					...
					LogFunction("glVertexStream1dvATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexStream2ATI(Int32 stream, Int16[] coords)
		{
			unsafe {
				fixed (Int16* p_coords = coords)
				{
					...
					LogFunction("glVertexStream2svATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexStream2ATI(Int32 stream, Int32[] coords)
		{
			unsafe {
				fixed (Int32* p_coords = coords)
				{
					...
					LogFunction("glVertexStream2ivATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexStream2ATI(Int32 stream, float[] coords)
		{
			unsafe {
				fixed (float* p_coords = coords)
				{
					...
					LogFunction("glVertexStream2fvATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexStream2ATI(Int32 stream, double[] coords)
		{
			unsafe {
				fixed (double* p_coords = coords)
				{
					...
					LogFunction("glVertexStream2dvATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexStream3ATI(Int32 stream, Int16[] coords)
		{
			unsafe {
				fixed (Int16* p_coords = coords)
				{
					...
					LogFunction("glVertexStream3svATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexStream3ATI(Int32 stream, Int32[] coords)
		{
			unsafe {
				fixed (Int32* p_coords = coords)
				{
					...
					LogFunction("glVertexStream3ivATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexStream3ATI(Int32 stream, float[] coords)
		{
			unsafe {
				fixed (float* p_coords = coords)
				{
					...
					LogFunction("glVertexStream3fvATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexStream3ATI(Int32 stream, double[] coords)
		{
			unsafe {
				fixed (double* p_coords = coords)
				{
					...
					LogFunction("glVertexStream3dvATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexStream4ATI(Int32 stream, Int16[] coords)
		{
			unsafe {
				fixed (Int16* p_coords = coords)
				{
					...
					LogFunction("glVertexStream4svATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexStream4ATI(Int32 stream, Int32[] coords)
		{
			unsafe {
				fixed (Int32* p_coords = coords)
				{
					...
					LogFunction("glVertexStream4ivATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexStream4ATI(Int32 stream, float[] coords)
		{
			unsafe {
				fixed (float* p_coords = coords)
				{
					...
					LogFunction("glVertexStream4fvATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void VertexStream4ATI(Int32 stream, double[] coords)
		{
			unsafe {
				fixed (double* p_coords = coords)
				{
					...
					LogFunction("glVertexStream4dvATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void NormalStream3ATI(Int32 stream, sbyte[] coords)
		{
			unsafe {
				fixed (sbyte* p_coords = coords)
				{
					...
					LogFunction("glNormalStream3bvATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void NormalStream3ATI(Int32 stream, Int16[] coords)
		{
			unsafe {
				fixed (Int16* p_coords = coords)
				{
					...
					LogFunction("glNormalStream3svATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void NormalStream3ATI(Int32 stream, Int32[] coords)
		{
			unsafe {
				fixed (Int32* p_coords = coords)
				{
					...
					LogFunction("glNormalStream3ivATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void NormalStream3ATI(Int32 stream, float[] coords)
		{
			unsafe {
				fixed (float* p_coords = coords)
				{
					...
					LogFunction("glNormalStream3fvATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void NormalStream3ATI(Int32 stream, double[] coords)
		{
			unsafe {
				fixed (double* p_coords = coords)
				{
					...
					LogFunction("glNormalStream3dvATI({0}, {1})", LogEnumName(stream), coords);
				}
			}
			DebugCheckErrors(null);
		}

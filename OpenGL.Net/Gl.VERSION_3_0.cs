...
namespace OpenGL
{
	public partial class Gl
	{
		...
		public static void TransformFeedbackVaryings(UInt32 program, String[] varyings, Int32 bufferMode)
		{
			...
			LogFunction("glTransformFeedbackVaryings({0}, {1}, {2}, {3})", program, varyings.Length, varyings, LogEnumName(bufferMode));
			DebugCheckErrors(null);
		}
		...
		public static void ClearBuffer(Int32 buffer, Int32 drawbuffer, Int32[] value)
		{
			unsafe {
				fixed (Int32* p_value = value)
				{
					...
					LogFunction("glClearBufferiv({0}, {1}, {2})", LogEnumName(buffer), drawbuffer, value);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void ClearBuffer(Int32 buffer, Int32 drawbuffer, UInt32[] value)
		{
			unsafe {
				fixed (UInt32* p_value = value)
				{
					...
					LogFunction("glClearBufferuiv({0}, {1}, {2})", LogEnumName(buffer), drawbuffer, value);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void ClearBuffer(Int32 buffer, Int32 drawbuffer, float[] value)
		{
			unsafe {
				fixed (float* p_value = value)
				{
					...
					LogFunction("glClearBufferfv({0}, {1}, {2})", LogEnumName(buffer), drawbuffer, value);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void GetRenderbufferParameter(Int32 target, Int32 pname, [Out] Int32[] @params)
		{
			unsafe {
				fixed (Int32* p_params = @params)
				{
					...
					LogFunction("glGetRenderbufferParameteriv({0}, {1}, {2})", LogEnumName(target), LogEnumName(pname), @params);
				}
			}
			DebugCheckErrors(null);
		}
		...
		public static void GetFramebufferAttachmentParameter(Int32 target, Int32 attachment, Int32 pname, [Out] Int32[] @params)
		{
			unsafe {
				fixed (Int32* p_params = @params)
				{
					...
					LogFunction("glGetFramebufferAttachmentParameteriv({0}, {1}, {2}, {3})", LogEnumName(target), LogEnumName(attachment), LogEnumName(pname), @params);
				}
			}
			DebugCheckErrors(null);
		}

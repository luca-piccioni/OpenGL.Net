...
namespace OpenGL
{
	...
	/// </summary>
	public class MatrixDouble4x4 : MatrixDouble, IMatrix4x4
	{
		#region Constructors
		...
		/// </exception>
		public MatrixDouble4x4(IMatrix m)
			: base(m)
		{
		...
		/// </returns>
		public static Vertex4d operator *(MatrixDouble4x4 m, Vertex4d v)
		{
			Vertex4d result;
		...
		/// </summary>
		/// <param name="a">
		/// A <see cref="Matrix4x4"/> to be converted to <see cref="MatrixDouble4x4"/>.
		/// </param>
		/// <returns>
		/// A <see cref="MatrixDouble4x4"/> equivalent to <paramref name="a"/>.
		/// </returns>
		public static implicit operator MatrixDouble4x4(Matrix4x4 a)
		{
			if (a == null)
				return (null);
			
			MatrixDouble4x4 matrix = new MatrixDouble4x4();
		...
		{
			return (new MatrixDouble4x4(this));
		}
		...
		/// </exception>
		public new MatrixDouble4x4 GetInverseMatrix()
		{
#if XXX
...
#endif
			return ((MatrixDouble4x4)base.GetInverseMatrix());	// Most general case, but rare
#if XXX
			else {
		...
		{
			return (new MatrixDouble3x3(this, c, r));
		}

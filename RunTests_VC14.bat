...
%TEST_RUN% OpenGL.Net.Test\bin\net461\Release\OpenGL.Net.Test.dll               %TEST_WHERE% %TEST_OPTS% --result=OpenGL.Net_net461.xml
%TEST_RUN% OpenGL.Net.Test\bin\net461\Release\OpenGL.Net.Test.dll               %TEST_WHERE% %TEST_OPTS% --result=OpenGL.Net_net461_x86.xml --x86
%TEST_RUN% OpenGL.Net.Test\bin\net35\Release\OpenGL.Net.Test.dll                %TEST_WHERE% %TEST_OPTS% --result=OpenGL.Net_net35.xml
%TEST_RUN% OpenGL.Net.Test\bin\net35\Release\OpenGL.Net.Test.dll                %TEST_WHERE% %TEST_OPTS% --result=OpenGL.Net_net35_x86.xml --x86 
%TEST_RUN% OpenGL.Net.CoreUI.Test\bin\net461\Release\OpenGL.Net.CoreUI.Test.dll %TEST_WHERE% %TEST_OPTS% --result=OpenGL.Net.CoreUI_net461.xml

...
namespace BindingsGen.GLSpecs
{
    ...
    public class Command
    {
        ...
        private List<CommandParameter>[] GetOverridenImplementations(RegistryContext ctx)
        {
            ...
            bool isUnsafeCompatible = ((Flags & CommandFlags.UnsafeParams) != 0) && CommandParameterUnsafe.IsCompatible(this);
        ...
        private void GenerateImplementation_Generics(SourceStreamWriter sw, RegistryContext ctx)
        {
            ...
            for (int i = 0; i < genericParameters.Count; i++)
            {
                ...
                if (i < genericParameters.Count - 1) {
                    ...
                    sw.Write("({0})System.Runtime.CompilerServices.Unsafe.AsPointer(ref {1})", originalParam.GetImportType(this), genericParam.ImplementationName);
                }

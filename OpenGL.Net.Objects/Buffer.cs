...
namespace OpenGL.Objects
{
	...
	public abstract class Buffer : GraphicsResource, IBindingResource
	{
		...
		/// </summary>
		/// <exception cref="InvalidOperationException">
		/// Exception thrown if this Buffer is not mapped, or if it was mapped using <see cref="Map(GraphicsContext, BufferAccessARB)"/>
		/// method.
		/// </exception>
		public void Unmap()
		{
		...
		protected override void CreateObject(GraphicsContext ctx)
		{
			...
			if ((CpuBufferAddress == IntPtr.Zero) && ((Hint != BufferHint.StaticCpuDraw) && (Hint != BufferHint.DynamicCpuDraw)))
				throw new InvalidOperationException("no CPU buffer");
